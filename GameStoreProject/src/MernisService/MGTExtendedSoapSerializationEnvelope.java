...
public class MGTExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(MGTDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new MGTStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static MGTDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static MGTDateTimeConverter dateTimeConverter = new MGTStandardDateTimeConverter();

    public MGTExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public MGTExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new MGTMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=MGTHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,MGTExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=MGTHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
