...
public class MGTKPSPublicSoap
{
    ...
    public MGTKPSPublicSoap(){}

    public MGTKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public MGTKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        MGTExtendedSoapSerializationEnvelope envelope= new MGTExtendedSoapSerializationEnvelope(MGTExtendedSoapSerializationEnvelope.VER11);
