...
public class TAVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(TAVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new TAVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static TAVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static TAVDateTimeConverter dateTimeConverter = new TAVStandardDateTimeConverter();

    public TAVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public TAVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new TAVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=TAVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,TAVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=TAVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
