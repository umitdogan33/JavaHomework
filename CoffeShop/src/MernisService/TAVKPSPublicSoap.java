...
public class TAVKPSPublicSoap
{
    ...
    public TAVKPSPublicSoap(){}

    public TAVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public TAVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        TAVExtendedSoapSerializationEnvelope envelope= new TAVExtendedSoapSerializationEnvelope(TAVExtendedSoapSerializationEnvelope.VER11);
